...
import com.example.administrator.customview.recyclerview.RecycleViewAdapter;
...
public class MyItemTouchHelper<T extends BaseRecyAdapter> extends ItemTouchHelper.Callback {

    T adapter;

    public MyItemTouchHelper(T adapter) {
