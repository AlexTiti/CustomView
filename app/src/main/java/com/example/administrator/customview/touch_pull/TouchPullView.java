...
public class TouchPullView extends View {
    ...
    public static  int maxPullHeight ;
    ...
    private void init(Context context ,AttributeSet attrs) {
        ...
        maxPullHeight = array.getInteger(R.styleable.TouchPullView_maxPullHeight,400);
        minWidthPull = array.getInteger(R.styleable.TouchPullView_minWidthPull,220);
        ...
        Path path = new Path();
        mPath = path;
        pathInterpolator = PathInterpolatorCompat.create(circleRadius * 4.0f / maxPullHeight, 90f / MAX_DEGREE);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int minHeight = (int) (maxPullHeight * mProgress + getPaddingBottom() + getPaddingTop());
    ...
    private void updateLayout() {
        ...
        //可绘制区域高度
        final float y = getValues(0, maxPullHeight, mProgress);
